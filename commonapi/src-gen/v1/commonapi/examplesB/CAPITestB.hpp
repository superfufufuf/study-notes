...
*/
#ifndef V1_COMMONAPI_EXAMPLESB_CAPI_TEST_B_HPP_
#define V1_COMMONAPI_EXAMPLESB_CAPI_TEST_B_HPP_
...
const char* CAPITestB::getInterface() {
    return ("commonapi.examplesB.CAPITestB:v1_2");
}

CommonAPI::Version CAPITestB::getInterfaceVersion() {
...
#endif // V1_COMMONAPI_EXAMPLESB_CAPI_TEST_B_HPP_
