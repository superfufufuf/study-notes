...
*/
#ifndef V1_COMMONAPI_EXAMPLESA_CAPI_TEST_A_HPP_
#define V1_COMMONAPI_EXAMPLESA_CAPI_TEST_A_HPP_
...
const char* CAPITestA::getInterface() {
    return ("commonapi.examplesA.CAPITestA:v1_2");
}

CommonAPI::Version CAPITestA::getInterfaceVersion() {
...
#endif // V1_COMMONAPI_EXAMPLESA_CAPI_TEST_A_HPP_
