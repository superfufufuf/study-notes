...
#ifndef _FAST_DDS_GENERATED_USRDATA_H_
#define _FAST_DDS_GENERATED_USRDATA_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(USRDATA_SOURCE)
#define USRDATA_DllAPI __declspec( dllexport )
#else
#define USRDATA_DllAPI __declspec( dllimport )
#endif // USRDATA_SOURCE
#else
#define USRDATA_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define USRDATA_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure UsrData defined by the user in the IDL file.
 * @ingroup UsrData
 */
class UsrData
{
public:
     ...
     */
    eProsima_user_DllExport UsrData();
     ...
     * @param x Reference to the object UsrData that will be copied.
     */
    eProsima_user_DllExport UsrData(
            const UsrData& x);
     ...
     * @param x Reference to the object UsrData that will be copied.
     */
    eProsima_user_DllExport UsrData& operator =(
            const UsrData& x);
     ...
     * @param x UsrData object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_USRDATA_H_
